...
Description:
basic ml implementation to classify ascii images as specific characters using perceptrons (q1)
    ...
    def perform_update(self, datum, label):
        ...
        if guess == label:
            ...
            for feature in self.features:
                self.weights[guess][feature] -= datum[feature]
                self.weights[label][feature] += datum[feature]
